  ...
  return (
    <div className="work">
      ...
      <div className="caldesc">
        <p>
          Projects are the best way to learn JavaScript, and a calculator is one
          of the best projects to choose. A calculator covers all the complex
          interactions with UI and JavaScript while still being simple enough
      ...
      <div className="Img-border"></div>
        <div className="project-cal-Img">
          <a href="">
            <img src={calculator} alt="" width="500px" height="300px" />
          </a>
        </div>
        </div>
      </div>
